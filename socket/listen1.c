/******************************************************************************
*
*  File Name........: listen1.c  For Dr. Edwin Sha's security course
*  Usage: listen1 <port-number>
...
char ack_msg[]="Listen1 got your message.";
	    /* Acknowledeg message sent to the client*/

void process(char * a )
{
	char buf[?????????????????]; // Not compilable. A mystery for you.
	char *p=buf;
	int i;

	strcpy(buf, a);

//I am nice so I print this information for your reference. --Edwin Sha
